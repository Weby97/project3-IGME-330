...
//array of user's mastered champions
...
function getMasteryData(url) {
    // 1 - create a new XHR object
    let xhr = new XMLHttpRequest();

    // 2 - set the onload handler
    xhr.onload = masteryDataLoaded;
